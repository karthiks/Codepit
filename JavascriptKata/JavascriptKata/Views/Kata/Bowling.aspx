...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>"Bowling Game" Coding Kata</h2>
    
    <p>This script contained in this page is generated by perfoming the <a href="http://butunclebob.com/ArticleS.UncleBob.TheBowlingGameKata" target="_blank">Bowling Game Kata</a> on Uncle Bob's (Robert C. Martin) website.</p>
    <p>Unit testing is performed by using the <a href="http://docs.jquery.com/QUnit" target="_blank">qUnit Javascript testing framework</a>.</p>
